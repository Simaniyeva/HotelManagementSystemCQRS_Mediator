...
public class ServiceTypeUpdateDtoValidator : AbstractValidator<ServiceTypePostDto>
{
    public ServiceTypeUpdateDtoValidator()
    {
        RuleFor(c => c.Name)
            .NotEmpty()
            .NotNull()
            ...
            .MaximumLength(255)
            .Must(ValidName)
            .WithMessage(Messages.EnterValid(Messages.ServiceType));
    }
