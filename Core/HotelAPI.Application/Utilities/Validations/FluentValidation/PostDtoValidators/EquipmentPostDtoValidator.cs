...
public class EquipmentPostDtoValidator : AbstractValidator<EquipmentPostDto>
{
    public EquipmentPostDtoValidator()
    {
        RuleFor(c => c.Name)
            .NotEmpty()
            .NotNull()
            ...
            .MaximumLength(255)
            .Must(ValidName)
            .WithMessage(Messages.EnterValid(Messages.Equipment));
    }
